...
You can modify system prompts in middleware using either `system_prompt` (`string`) or `system_message` (@[`SystemMessage`]). The @[`ModelRequest`] provides both for maximum flexibility.
