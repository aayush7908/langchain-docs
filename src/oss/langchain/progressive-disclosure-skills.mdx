...
# Generate the skills prompt addendum
skills_prompt = list_available_skills()

# Create skill middleware instance
skill_middleware = SkillMiddleware(skills_prompt=skills_prompt)
